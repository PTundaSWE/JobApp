...
<%@ page import="org.paul.springbootlearning.jobapp.model.JobPost" %>
<%@ page import="org.paul.springbootlearning.jobapp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">ByyteNow Job Portal Web App</a>
